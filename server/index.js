...
app.use('/api/reservations/restaurantID=:restaurantID&date=:date', proxy({ target: 'http://localhost:3002', changeOrigin: true }));
app.use('/api/reservations/', proxy({ target: 'http://localhost:3002', changeOrigin: true }));
