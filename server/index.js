...
app.use('/api/reservations/restaurantID=:restaurantID&date=:date', proxy({ target: 'http://54.153.120.187:3002', changeOrigin: true }));
app.use('/api/reservations/', proxy({ target: 'http://54.153.120.187:3002', changeOrigin: true }));
